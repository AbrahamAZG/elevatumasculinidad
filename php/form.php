<?php
$recipient = 'azimga@hotmail.com'; // Enter the recipient's email address here.
$subject   = 'Informacion'; // Enter the subject of the email here.
$success   = 'Tu mensaje se envió con éxito.';
$error     = 'Hubo un error';
$invalid   = 'Falta validar datos';
